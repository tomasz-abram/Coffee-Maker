...
public class UserService implements UserServiceInterface {
    ...
    public UserService(UserRepository userRepository, CoffeeUserService coffeeUserService) {
    ...
    public User save(UserRegistrationDto registrationDto) {
        User user = new User(registrationDto.getUserName(), new BCryptPasswordEncoder().encode(registrationDto.getPassword()), true, Collections.singleton(new Role("USER")));
